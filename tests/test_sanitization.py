...
class TestCredentialSanitization:
    ...
    def test_sanitize_credentials_malicious_username(self):
        ...
        username, password = InputSanitizer.sanitize_credentials(malicious_username, "testpass")
    ...
    def test_sanitize_credentials_long_username(self):
        ...
        username, password = InputSanitizer.sanitize_credentials(long_username, "testpass")
    ...
    def test_sanitize_credentials_special_chars_username(self):
        ...
        username, password = InputSanitizer.sanitize_credentials(special_username, "testpass")
...
class TestFileValidation:
    ...
    async def test_validate_file_upload_invalid_extension(self, mock_file_upload):
        ...
        mock_file = mock_file_upload("malicious.exe", b"MZexecutable", "application/octet-stream")
