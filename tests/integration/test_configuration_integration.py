...
class TestConfigurationIntegration:
    ...
    def test_configuration_loading_from_environment(self):
        ...
        with patch.dict(os.environ, test_env_vars):
            ...
            assert settings.cassandra_hosts == "cassandra1.int.example.com,cassandra2.int.example.com"
...
class TestEnvironmentSpecificConfiguration:
    ...
    def test_configuration_environment_detection(self):
        ...
        environments = [
            ("development", {"POSTGRES_HOST": "localhost", "POSTGRES_SSLMODE": "disable"}),
            ("staging", {"POSTGRES_HOST": "staging-db.example.com", "POSTGRES_SSLMODE": "require"}),
            ("production", {"POSTGRES_HOST": "prod-db.example.com", "POSTGRES_SSLMODE": "verify-full"}),
        ]
