...
class ConfigService(BaseService):
    ...
    async def _load_configuration(self) -> None:
        ...
        for key, schema_item in self.config_schema.items():
            ...
            if env_value is not None:
                try:
                    parsed_value = self._parse_config_value(env_value, schema_item.config_type)
            ...
            if schema_item.default_value is not None:
                ...
                raise ConfigurationError(
                    ...
                    details={"missing_key": key, "description": schema_item.description},
    ...
    async def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        for key, schema_item in self.config_schema.items():
            ...
            item_dict["value"] = "***" if schema_item.is_secret else bool(self._config_cache.get(key))
    ...
    async def set_config(
        ...
        try:
            ...
            self.log_operation("config_updated", {
                "key": key,
                "user_id": user_id,
                "is_secret": schema_item.is_secret
            })
    ...
    async def delete_config(self, key: str, user_id: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    async def reload_configuration(self) -> Dict[str, Any]:
        ...
        try:
            ...
            self.log_operation("config_reloaded", {
                "old_count": old_count,
                "new_count": new_count
            })
