...
class HealthChecker:
    ...
    async def _check_configuration(self) -> Dict[str, Any]:
        ...
        if self.settings.auth_username == "admin" and self.settings.auth_password == "changeme":
    ...
    async def _check_database_connectivity(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if not self.settings.postgres_host or self.settings.postgres_host == "localhost":
                return {
                    "status": HealthStatus.HEALTHY.value,
    ...
    async def _check_external_dependencies(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "configured_dependencies": sum(1 for dep in dependencies.values() if dep["configured"])
        }
