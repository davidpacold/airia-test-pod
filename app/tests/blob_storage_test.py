...
class BlobStorageTest(BaseTest):
    ...
    def __init__(self):
        ...
        self.test_content = f"Test content from Airia Test Pod - {datetime.utcnow().isoformat()}"
    ...
    def is_configured(self) -> bool:
        ...
        return bool(
            self.settings.blob_account_name and 
            self.settings.blob_account_key and
            self.settings.blob_container_name
        )
        
    def get_configuration_help(self) -> str:
        """Return configuration help"""
        return ("Configure Azure Blob Storage using environment variables: "
    ...
    def run_test(self) -> TestResult:
        ...
        try:
            ...
            critical_tests = [client_result, container_result, upload_result, download_result]
    ...
    def _test_container_operations(self, blob_service_client: BlobServiceClient) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "details": {
                    ...
                    "created_on": properties["creation_time"].isoformat() if properties.get("creation_time") else None,
                    "last_modified": properties["last_modified"].isoformat() if properties.get("last_modified") else None
                }
            }
        except Exception as e:
            return {
    ...
    def _test_upload_blob(self, blob_service_client: BlobServiceClient) -> Dict[str, Any]:
    ...
    def _test_download_blob(self, blob_service_client: BlobServiceClient) -> Dict[str, Any]:
    ...
    def _test_list_blobs(self, blob_service_client: BlobServiceClient) -> Dict[str, Any]:
    ...
    def _test_cleanup_blob(self, blob_service_client: BlobServiceClient) -> Dict[str, Any]:
