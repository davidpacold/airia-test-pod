...
class DocumentIntelligenceTest(BaseTest):
    ...
    def get_configuration_help(self) -> str:
        return ("Azure Document Intelligence configuration required. "
    ...
    def run_test(self) -> TestResult:
        ...
        try:
            ...
            if self.test_document_url:
                ...
                analysis_result = self._test_document_analysis_url(client, self.test_document_url)
            ...
            if not model_result["success"]:
                ...
                result.add_log("WARNING", f"Model info test failed: {model_result.get('message', 'Unknown error')}")
            
            if all_passed:
                result.complete(True, "All Document Intelligence tests passed successfully")
            else:
    ...
    def _test_document_analysis_url(self, client: DocumentAnalysisClient, document_url: str) -> Dict[str, Any]:
    ...
    def _test_document_analysis_content(self, client: DocumentAnalysisClient) -> Dict[str, Any]:
