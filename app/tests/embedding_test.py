...
class EmbeddingTest(BaseTest):
    ...
    def test_description(self) -> str:
        return "Tests OpenAI-compatible embedding model endpoints for text vectorization"
    ...
    def get_configuration_help(self) -> str:
        return ("Embedding model testing requires configuration. "
    ...
    def run_test(self) -> TestResult:
        ...
        try:
            ...
            critical_tests_passed = (
                single_embedding_result["success"] and 
                batch_embedding_result["success"]
            )
            
            if critical_tests_passed:
                embedding_dim = single_embedding_result.get("details", {}).get("dimension", "unknown")
                result.complete(
                    True,
        ...
        try:
            ...
            return {
                ...
                "details": {
                    ...
                    "usage": {
                        "prompt_tokens": getattr(response, 'usage', {}).prompt_tokens if hasattr(response, 'usage') else None,
        ...
        try:
            ...
            return {
                ...
                "details": {
                    ...
                    "response_time_seconds": round(response_time, 3),
                    "avg_time_per_embedding": round(response_time / len(embeddings), 3) if embeddings else 0,
                    "usage": {
                        "prompt_tokens": getattr(response, 'usage', {}).prompt_tokens if hasattr(response, 'usage') else None,
                        "total_tokens": getattr(response, 'usage', {}).total_tokens if hasattr(response, 'usage') else None
                    }
