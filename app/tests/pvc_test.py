...
class PVCTest(BaseTest):
    ...
    def get_configuration_help(self) -> str:
        return ("Kubernetes client configuration required. "
    ...
    def _test_storage_classes(self, storage_v1: client.StorageV1Api, result: TestResult):
        ...
        try:
            ...
            if not class_names:
                result.add_sub_test("List Storage Classes", {
                    "success": False,
    ...
    def _test_namespace_access(self, v1: client.CoreV1Api, result: TestResult):
        ...
        try:
            ...
            result.add_sub_test("Namespace Access", {
                "success": True,
    ...
    def _test_pvc_creation(self, v1: client.CoreV1Api, pvc_name: str, result: TestResult) -> bool:
        """Test PVC creation"""
        try:
            # Create PVC manifest
            pvc_manifest = client.V1PersistentVolumeClaim(
                metadata=client.V1ObjectMeta(
                    name=pvc_name,
                    labels={"app": "airia-test-pod", "test": "pvc"}
                ),
            ...
            result.add_sub_test("PVC Creation", {
                "success": True,
    ...
    def _test_pvc_status(self, v1: client.CoreV1Api, pvc_name: str, result: TestResult):
        ...
        try:
            ...
            result.add_sub_test("PVC Status", {
                "success": True,
    ...
    def _test_pvc_deletion(self, v1: client.CoreV1Api, pvc_name: str, result: TestResult):
        ...
        try:
            ...
            result.add_sub_test("PVC Cleanup", {
                "success": True,
