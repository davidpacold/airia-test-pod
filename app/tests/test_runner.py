...
class TestRunner:
    ...
    def run_test(self, test_id: str) -> Optional[Dict[str, Any]]:
        ...
        self.test_results[test_id] = {
            ...
            "last_run": result.end_time.isoformat() if result.end_time else datetime.utcnow().isoformat(),
    ...
    def run_all_tests(self, skip_optional: bool = False) -> Dict[str, Any]:
        ...
        return {
            ...
            "passed_count": len([r for r in results.values() if r.status == TestStatus.PASSED]),
            "failed_count": len([r for r in results.values() if r.status == TestStatus.FAILED]),
            "skipped_count": len([r for r in results.values() if r.status == TestStatus.SKIPPED]),
    ...
    def get_test_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "overall_status": "passed" if all(s == "passed" or s == "skipped" for s in statuses) else "failed"
        }
