...
class S3Test(BaseTest):
    ...
    def __init__(self):
        ...
        self.session_token = os.getenv("AWS_SESSION_TOKEN", "")  # Optional for temporary credentials
    ...
    def get_configuration_help(self) -> str:
        return ("Amazon S3 storage testing requires configuration. "
    ...
    def run_test(self) -> TestResult:
        ...
        try:
            ...
            if bucket_access_result["success"]:
                ...
                result.add_sub_test("file_operations", {
                    "success": False,
            ...
            critical_tests_passed = (
                ...
                list_buckets_result["success"] and
                bucket_access_result["success"]
            )
            ...
            if critical_tests_passed:
                result.complete(
                    ...
                    "Amazon S3 storage tests completed successfully",
                    {
                        ...
                        "endpoint": self.endpoint_url or f"https://s3.{self.aws_region}.amazonaws.com"
                    }
                )
            else:
                failed_tests = []
